...
public class Receive2 {
    public static void main(String[] args) {
        ...
        try {
            ...
            channel.queueDeclare("topicQ2",true,false,false,null);
            channel.exchangeDeclare("shy1","topic",true);
            channel.queueBind("topicQ2","shy1","aa.#");

            channel.basicConsume("topicQ2",true,"",new DefaultConsumer(channel){
                public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                    String message = new String(body);
                    System.out.println("消费者2aa----"+message);
                }
            });
        } catch (IOException e) {
            e.printStackTrace();
